...
/* ------------------------------------------------------------------ */
/* 6. Hex address feed (decorative, generated)                         */
/* ------------------------------------------------------------------ */
...
function initLiveWiring() {
  ...
  watch(document.getElementById("stat-direct-peers"), () => {
    ...
    if (next > live.peers) radar.pings.push({ t: performance.now() / 1000 });
    live.peers = next;
...
/* ------------------------------------------------------------------ */
/* 9. Navigation helpers for new action buttons                        */
/* ------------------------------------------------------------------ */
